...
{
    [Info("My Hot Air Balloon", "BuzZ[PHOQUE]", "0.1.2")]
...
#region CONFIG
    ...
    protected override void LoadDefaultConfig()
        ...
        private void LoadVariables()
        {
            ...
            barbottom = Convert.ToDouble(GetConfig("HUD position - bar bottom", "0.08 by default", "0.08"));
...
/////////////////////////
        ...
        void NavigatorBarHUD(HotAirBalloon Balloon, BaseEntity Loloon, BasePlayer player)
        {
			...
			DaBalloonNavigatorBar = CuiElement.Add(new CuiPanel{Image ={Color = "0.0 0.0 0.0 0.2"},RectTransform ={AnchorMin = $"0.645 {barbottom+0.04}",AnchorMax = $"0.68 {barbottom+0.07}"},CursorEnabled = false
//                }, new CuiElement().Parent = "Overlay", DaBalloonBar);
            ...
            Vector3 eastwind = new Vector3(300,0,0);
            Vector3 westwind = new Vector3(-300,0,0);
            Vector3 northwind = new Vector3(0,0,300);
            Vector3 southwind = new Vector3(0,0,-300);
			...
			DaBalloonNavigatorBarWest = CuiElementWest.Add(new CuiPanel{Image ={Color = "0.0 0.0 0.0 0.2"},RectTransform ={AnchorMin = $"0.61 {barbottom+0.04}",AnchorMax = $"0.64 {barbottom+0.07}"},CursorEnabled = false
//                }, new CuiElement().Parent = "Overlay", DaBalloonBar);
            });

			var CuiElementEast = new CuiElementContainer();
			DaBalloonNavigatorBarEast = CuiElementEast.Add(new CuiPanel{Image ={Color = "0.0 0.0 0.0 0.2"},RectTransform ={AnchorMin = $"0.685 {barbottom+0.04}",AnchorMax = $"0.715 {barbottom+0.07}"},CursorEnabled = false
//                }, new CuiElement().Parent = "Overlay", DaBalloonBar);
            });
            
			var CuiElementNorth = new CuiElementContainer();
			DaBalloonNavigatorBarNorth = CuiElementNorth.Add(new CuiPanel{Image ={Color = "0.0 0.0 0.0 0.2"},RectTransform ={AnchorMin = $"0.645 {barbottom+0.08}",AnchorMax = $"0.68 {barbottom+0.11}"},CursorEnabled = false
//                }, new CuiElement().Parent = "Overlay", DaBalloonBar);
            });

			var CuiElementSouth = new CuiElementContainer();
			DaBalloonNavigatorBarSouth = CuiElementSouth.Add(new CuiPanel{Image ={Color = "0.0 0.0 0.0 0.2"},RectTransform ={AnchorMin = $"0.645 {barbottom}",AnchorMax = $"0.68 {barbottom+0.03}"},CursorEnabled = false
//                }, new CuiElement().Parent = "Overlay", DaBalloonBar);
            });
...
///////////////////////////
        ...
        {
			var CuiElement = new CuiElementContainer();
			DaBalloonBar = CuiElement.Add(new CuiPanel{Image ={Color = "0.0 0.0 0.0 0.2"},RectTransform ={AnchorMin = $"0.345 {barbottom}",AnchorMax = $"0.64 {barbottom+0.03}"},CursorEnabled = false
//                }, new CuiElement().Parent = "Overlay", DaBalloonBar);
            });
        ...
        private void BalloonTimer(HotAirBalloon Balloon, BaseEntity Loloon, BasePlayer player)
        {
           ...
           /* var zicontainer = Loloon.gameObject.GetComponent<LootContainer>();
            ...
            Timer newtimer = timer.Every(2f, () =>
            {
                ...
                CuiHelper.DestroyUi(player, DaBalloonNavigatorBarNorth);
                CuiHelper.DestroyUi(player, DaBalloonNavigatorBarSouth);
                //CuiHelper.DestroyUi(player, DaBalloonBarLift);
