...
namespace Oxide.Plugins
{
    ...
    class Crosshair : RustPlugin
    {
        ...
        private void SendHelpText(BasePlayer player)
        {
			...
			stringBuilder.Append("/crosshair - toggle crosshair.");
        ...
        {
            PrintToChat(player, "<color=#008000ff>" + this.Name + "</color>: " + message);
        }

        private void PrintPluginMessageToChat(string message)
        {
            PrintToChat("<color=#008000ff>" + this.Name + "</color>: " + message);
        }
